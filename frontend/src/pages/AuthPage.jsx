    ...
    <div className="auth-container">
      <div className="auth-left">
        <div className="auth-hero">
          <div className="brand-container">
            <img src="/Zync2.png" alt="Zync" className="brand-logo" />
      ...
      <div className="auth-right">
        <div className="auth-image-container">
          <img src="/Zync3.png" alt="Team collaboration dashboard showing real-time messaging and video calls" className="auth-image" />
